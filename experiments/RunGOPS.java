...
//                    System.out.println();
            ...
            output.writeOutput(outpath + "/GOPS/GOPS_" + dataset[d] + "_" +"0" + ".txt");
...
//            List<List<Integer>> output1 = output.getOutput();
...
//            System.out.println("Macro: " + macroGMean);
//            System.out.println("Micro: " + microGMean);
//            System.out.println("Example: " + exampleGMean);
//
//
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/GOPS_" + dataset[d] + ".txt")));
