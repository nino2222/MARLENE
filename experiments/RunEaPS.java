...
//            for (int r = 0; r < 30; r++) {
            int r = Integer.valueOf(args[0]);
                System.out.println("EaPS" + dataset[d] + " : " + r);
...
//                    eva.update(pred, labels);
            ...
            output.writeOutput(outpath + "/EaPS/EaPS_" + dataset[d] + "_" +r + ".txt");
...
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/EaPS/EaPS_" + dataset[d] + "_" +r +  ".txt")));
