...
//        int[] numOfInstance = new int[]{120919};
        ...
        for (int d = 0; d < dataset.length; d++) {
            System.out.println("GOCC" + dataset[d]);
...
//                    eva.update(pred, labels);
            ...
            output.writeOutput(outpath + "/GOCC/GOCC_" + dataset[d] + "_" +"0" + ".txt");
...
//
//
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/GOCC_" + dataset[d] + ".txt")));
