...
//                    eva.update(pred, labels);
            ...
            output.writeOutput(outpath + "/GORT/GORT_" + dataset[d] + "_" + "0"  + ".txt");
...
//
//
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/GORT_" + dataset[d] + ".txt")));
