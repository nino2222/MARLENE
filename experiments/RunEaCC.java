...
//        String[] dataset = new String[]{ "Ohsumed", "Reuters", "Yeast", "20NG", "TMC2007", "IMDB"};
//        int[] numOfLabels = new int[]{ 23, 103, 14, 20, 22, 28};
...
//            for (int r = 0; r < 30; r++) {
            int r = Integer.valueOf(args[0]);
                System.out.println("EaCC" + dataset[d] + " : " + r);
                ...
                learner.baseLearnerOption.setValueViaCLIString(
                        "multilabel.MEKAClassifier -l (meka.classifiers.multilabel.incremental.CCUpdateable -W weka.classifiers.trees.HoeffdingTree)");
...
//                    eva.update(pred, labels);
            ...
            output.writeOutput(outpath + "/EaCC/EaCC_" + dataset[d] + "_" +r + ".txt");
...
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/EaCC/EaCC_" + dataset[d] + "_" + r + ".txt")));
