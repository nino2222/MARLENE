...
//        String[] dataset = new String[]{"TMC2007", "IMDB"};
//        int[] numOfLabels = new int[]{22, 28};
...
//            for (int r = 0; r < 30; r++) {
                System.out.println("EPS" + dataset[d] + " : " + r);
...
//                    eva.update(pred, labels);
                ...
                output.writeOutput(outpath + "/EPS/EPS_" + dataset[d] + "_" +r + ".txt");
...
//            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(path + "/EPS_" + dataset[d] + ".txt")));
